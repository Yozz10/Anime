...
export default function RootLayout({
  ...
  return (
    <html lang="id">
      <body className="bg-gradient-to-br from-pink-50 via-rose-50 to-pink-100 text-gray-800 font-inter min-h-screen selection:bg-pink-200 selection:text-pink-900">
        {/* 🌸 Loading Bar */}
        <LoadingBar />

        {/* 🌸 Navbar */}
        <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-md shadow-sm border-b border-pink-100">
        ...
        <footer className="text-center text-sm text-gray-500 py-6 border-t border-pink-200 mt-10 bg-white/50 backdrop-blur-sm">
          <p>
            ...
            <span className="font-semibold text-pink-600">AnimeID</span>
          </p>
        </footer>
      </body>
    </html>
